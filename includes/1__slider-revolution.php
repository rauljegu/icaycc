...
if (!function_exists('mostrarSliderRevolution')) {
    ...
    function mostrarSliderRevolution($url, $alias)
    {
        ...
        /*
         * Diferir las inicializaciones hasta que todos los módulos estén
         * impresos. Revolution realiza comprobaciones globales al inicializar.
         */
        if (empty($GLOBALS['revslider_remote_shutdown_registered'])) {
            $GLOBALS['revslider_remote_shutdown_registered'] = true;
            $GLOBALS['revslider_remote_init_scripts'] = array();
            ...
            register_shutdown_function(function () {
                ...
                foreach ($GLOBALS['revslider_remote_init_scripts'] as $scriptPendiente) {
                    echo $scriptPendiente;
                }
            });
        }
